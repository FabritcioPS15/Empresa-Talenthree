...
import DescargablesPage from './pages/DescargablesPage';
            ...
            <Router>
              <ScrollToTop>
                <Routes>
                  ...
                  <Route path="/recursos" element={<Layout><RecursosPage /></Layout>} />
                  <Route path="/blog" element={<Layout><BlogPage /></Layout>} />
                  <Route path="/podcast" element={<Layout><PodcastPage /></Layout>} />
                  <Route path="/descargables" element={<Layout><DescargablesPage /></Layout>} />
