...
const InglesTrabajoPage: React.FC = () => {
  ...
  const course = {
    ...
    duration: '6 meses',
    benefits: [
      'Certificación en inglés profesional',
      'Acceso a plataforma de práctica',
      'Mentorías con profesores nativos'
    ],
    level: '' as const,
...
export default InglesTrabajoPage; 