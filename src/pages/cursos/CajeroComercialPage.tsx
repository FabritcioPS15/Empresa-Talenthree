...
const CajeroComercialPage: React.FC = () => {
  ...
  const course = {
    ...
    duration: '4 meses',
    benefits: [
      'Certificación en operaciones de caja',
      'Acceso a simuladores de terminales POS',
      'Mentorías con expertos en finanzas'
    ],
    level: '' as const,
...
export default CajeroComercialPage; 