        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              whileHover={{ x: 5 }}
            >
              La evolución de la gestión del talento. Impulsa tu futuro ahora con TYX.
            </motion.p>
            <div className="flex space-x-4 pt-2">
              {[
                ...
                <motion.a
                  ...
                  aria-label={label}
                  className="p-2.5 rounded-lg bg-primary-800 hover:bg-purple-600 text-purple-200 hover:text-white"
                  whileHover={{
                    y: -2,
                    rotate: [0, -10, 10, 0],
              ...
              {[
                ...
                >
                  <NavLink
                    to={to}
                    className={({ isActive }) =>
                      `flex items-center gap-2 font-medium transition-all duration-300 hover:text-purple-400 ${isActive ? "text-purple-700 font-semibold" : "text-purple-500"
                      }`
                    }
                  >
                    {({ isActive }) => (
        ...
        >
          <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
            <motion.p
              ...
              whileHover={{ scale: 1.02 }}
            >
              &copy; {currentYear} TYX International. Todos los derechos reservados.
            </motion.p>
